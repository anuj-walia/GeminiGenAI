...
error_file_list = []
file_counter = 0
with open(output_response_file, "a+") as model_output_file,open(output_processed_files, "a+") as proceesed_file,open(output_error_files, "a+") as error_file :
    for file in genai.list_files():
        try:
            ...
            json.dump(response_list, model_output_file, indent=4)
            json.dump(processed_file_list, proceesed_file, indent=4)
        except error as e:
            print(f"Error decoding JSON: {e}")
            json.dump(processed_file_list, output_error_files, indent=4)
...
with open(output_response_file, "w") as file,open(output_processed_files, "w") as proceesed_file,open(output_error_files, "w") as error_file :
